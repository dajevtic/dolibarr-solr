...
if (! $user->rights->elbsolr->read) accessforbidden();
...
llxHeader("",$langs->trans("ElbSolrArea"));

print load_fiche_titre($langs->trans("ElbSolrArea"),'','elbsolr.png@elbsolr');
...
// Draft MyObject
if (! empty($conf->elbsolr->enabled) && $user->rights->elbsolr->read)
{
	$langs->load("orders");
