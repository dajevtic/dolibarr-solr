...
dol_include_once("/elbsolr/class/myobject.class.php");


/**
 * mailing_mailinglist_elbsolr
 */
class mailing_mailinglist_elbsolr_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_elbsolr_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('elbsolr',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/elbsolr/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_elbsolr_myobject.modules.php: mailing ".$num." targets found");
