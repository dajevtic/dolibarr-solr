 ...
 *      - interface_99_modElbSolr_MyTrigger.class.php
...
/**
 *  Class of triggers for ElbSolr module
 */
class InterfaceElbSolrTriggers extends DolibarrTriggers
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "ElbSolr triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'elbsolr@elbsolr';
	}
	...
	{
		if (empty($conf->elbsolr->enabled)) return 0;     // Module not active, we do nothing
		...
		switch ($action) {
			...
			case "ECMFILES_CREATE":
				...
				//Do not execute if not file is uploaded - because triggers is called on opening linked files tab
