...
/**
 * \file    modulebuilder/template/core/boxes/elbsolrwidget1.php
 * \ingroup elbsolr
 * \brief   Widget provided by ElbSolr
 *
 ...
 */
class elbsolrwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "elbsolrbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "elbsolr@elbsolr";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->elbsolr->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/elbsolr/class/elbsolr.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ElbSolrBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_elbsolr@elbsolr',
