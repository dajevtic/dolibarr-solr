...
/**
 * \file    test/functional/ElbSolrFunctionalTest.php
 * \ingroup elbsolr
 ...
 * @package Testelbsolr
 */
class ElbSolrFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/elbsolr/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('elbsolr/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/elbsolr/admin/about.php');
		$this->authenticate();
		return $this->assertContains('elbsolr/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('elbsolrwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modElbSolr_ElbSolrTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modElbSolr_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
